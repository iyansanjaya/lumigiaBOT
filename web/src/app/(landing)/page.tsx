...
const features = [
  {
    ...
    tags: ["Auto-Mod", "Anti-Raid", "Mod Logs"],
  },
  {
    icon: Ticket,
    color: "#4ADE80",
    ...
    tags: ["Klaim Staff", "Transkrip HTML", "Auto-Close"],
  },
  {
    icon: Headphones,
    color: "#22D3EE",
    ...
    tags: ["Join-to-Create", "Auto-Delete", "Custom Name"],
  },
  {
    icon: Users,
    color: "#FACC15",
  ...
  },
  {
    ...
    tags: ["Leaderboard", "Multiplier", "Role Rewards"],
  },
  {
    icon: Gift,
    color: "#60A5FA",
    ...
    tags: ["Auto-Reroll", "Role Requirements", "Timer"],
  },
  {
    icon: Video,
    color: "#FB7185",
    ...
    tags: ["Live Alerts", "Schedules", "Social Embeds"],
  },
  {
    icon: Palette,
    color: "#34D399",
    ...
    tags: ["Moderation", "Upvotes", "Showcase"],
  },
];
